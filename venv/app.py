...
"How often do you engage in physical activity?": [
   ...
   "How connected do you feel with friends and family?": [
   ...
   "How often do you engage in hobbies or activities you enjoy?": [
   ...
   "How calm and at ease do you feel on a daily basis?": [
   ...
   "How often do you feel content and optimistic?": [
   ...
   "How well have you been able to handle stress this week?": [
   ...
   "How well have you been able to concentrate on tasks recently?": [
   ...
   "How energized do you feel throughout the day?": [
   ...
   "How often do you eat healthy, balanced meals?": [
   ...
   "How well do you handle unexpected challenges or changes?": [
   ...
   "How well do you feel you are able to contain your emotions of anger and stress?": [
   ...
   "How often do you feel a sense of purpose or fulfillment in your daily life?": [
   ...
   "How often do you feel that you are able to express your emotions openly and honestly?": [
...
def index():
    if request.method == 'POST':
        responses = {question: int(request.form[question]) for question in questions.keys()}
        ...
        num_suggestions = 1 if len(low_score_questions) >= 5 else 2

        suggestions = {}
        for question in low_score_questions:
            suggestions[question] = questions[question][:num_suggestions]

        return render_template('results.html', average_score=average_score,
